sap.ui.define([
	...
	return BaseController.extend("salesorderviewer.SalesOrderViewer.controller.Master", {
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!this.byId("masterViewSettingsDialog")) {
				Fragment.load({
					id: this.getView().getId(),
					name: "salesorderviewer.SalesOrderViewer.view.MasterViewSettingsDialog",
					controller: this
				...
				this.byId("masterViewSettingsDialog").open(sDialogTab);
			}
		},
		...
		_applySortGroup: function (oEvent) {
			...
			if (mParams.groupItem) {
				var sGroupPath = mParams.groupItem.getKey(),
					bGroupDescending = mParams.groupDescending;
				aSorters.push(new Sorter(
					sGroupPath,
					bGroupDescending,
					true));
				oViewModel.setProperty("/groupingKey", sGroupPath);
			}
			if (mParams.sortItem) {
		...
		_getSortKeyName: function (sCountry) {
			var sResult = "",
				oViewModel = this.getModel("masterView");
			if (oViewModel.getProperty("/groupingKey") === "Address/Country") {
		...
		createGroupHeader: function (oGroup) {
			return new GroupHeaderListItem({
				title: this._getSortKeyName(oGroup.key),
				upperCase: false
			});
		},
		...
		_showDetail: function (oItem) {
			...
			this.getRouter().navTo("detailRT", {
				partnerId: oItem.getBindingContext().getProperty("BusinessPartnerID")
			}, bReplace);
		},
